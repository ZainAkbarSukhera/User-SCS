  ...
  const [mailList, setMailList] = useState([
      {
          ...
          displayDescription: 'Your purchase of the artwork is successful.',
          type: 'inbox',
          isImportant: true,
          isStar: true,
          // group: 'social',
          ...
          description: `
                          <p class="mail-content"> THIS IS A CONFIRMATION EMAIL. PLEASE DO NOT REPLY TO THIS EMAIL. You have successfully purchased the artwork "kingdom of love by abdullah qandeel". Refer to order section for updates on delivery. Reference number: #84510</p>
                            `,
      },
      // {
      //     id: 2,
                                                  ...
                                                  <ul className="sm:w-56">
                                                      <li>
                                                          <div className="flex items-center px-4 py-2">
                                                              ...
                                                              <div className="flex-1 font-montserrat-light text-yankees-blue">{selectedMail.type === 'sent_mail' ? 'ahmad1@gmail.com' : selectedMail.email}</div>
                                                          </div>
                                                      </li>
                                                      <li>
                                                          <div className="flex items-center px-4 py-2">
